...
public class WildberryBlock extends BlockCrops
  {
	...
	public WildberryBlock(String name) 
	  {
		super();
    ...
    protected Item getSeed()
      {
        return Init_PlantItems.wildberrySeeds;
      }
    protected Item getCrop()
      {
        return Init_PlantItems.wildberryItem;
      }
